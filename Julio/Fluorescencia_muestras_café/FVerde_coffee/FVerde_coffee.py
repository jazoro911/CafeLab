...
datos = pd.read_csv("FVerde_data.csv")
...
<body>
  ...
  <div>
    <p>Este espectro muestra el perfil de respuesta óptica de la muestra FVerde, con análisis cuantitativo por zonas espectrales específicas. La información obtenida puede relacionarse con compuestos funcionales presentes en la muestra.</p>
  </div>
